...
data14 = merged_table.assign(Percentage_of_Facilities = round((merged_table["Facilities_with_80_percent"]/merged_table["Total_Reported_Facilities"])*100,2))
...
data15 = data14
data15.drop(columns = ["Province Name","Facilities_with_80_percent","Total_Reported_Facilities"], inplace = True)
...
#graph = px.bar(
#    data15,
    #x = ["Facilities_with_80_percent", "Total_Reported_Facilities"],
    #y = "District Name",
#    orientation = "v",
#    title = "<b>Number of Facilities per District</b>",
 #   color_discrete_sequence = ["#0083B8"] * len(data15),
...
#hide_st_style = '''
            #   <style>
               #MainMenu {visibilityu : hidden;}
 #              footer {visibilityu : hidden;}
 #              header {visibilityu : hidden;}
    #           </style>
  #             '''
